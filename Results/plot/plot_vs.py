...
for i in range(len(AGV_COUNT)):
    ...
    if PLOT_TYPE == 'average':
        #centralized
        axis[int(i/2)][i%2].plot(avg_c_es, ls='dotted', label='ES Centralized', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_t_es, ls='dotted', label='ES Centralized, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_avgt_es, ls='dotted', label='ES Centralized, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_botht_es, ls='dotted', label='ES Centralized, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_cn, ls='dashed', label='ES-Canonical Centralized', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_t_cn, ls='dashed', label='ES-Canonical Centralized, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_avgt_cn, ls='dashed', label='ES-Canonical Centralized, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_botht_cn, ls='dashed', label='ES-Canonical Centralized, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_ga, label='CCEA Centralized', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_t_ga, label='CCEA Centralized, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_avgt_ga, label='CCEA Centralized, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_c_botht_ga, label='CCEA Centralized, both times', linewidth=0.5)
        #Intersection
        axis[int(i/2)][i%2].plot(avg_i_es, ls='dotted', label='MA-ES Intersection', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_t_es, ls='dotted', label='MA-ES Intersection, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_avgt_es, ls='dotted', label='MA-ES Intersection, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_botht_es, ls='dotted', label='MA-ES Intersection, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_cn, ls='dashed', label='MA-ES-Canonical Intersection', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_t_cn, ls='dashed', label='MA-ES-Canonical Intersection, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_avgt_cn, ls='dashed', label='MA-ES-Canonical Intersection, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_botht_cn, ls='dashed', label='MA-ES-Canonical Intersection, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_ga, label='CCEA Intersection', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_t_ga, label='CCEA Intersection, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_avgt_ga, label='CCEA Intersection, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_i_botht_ga, label='CCEA Intersection, both times', linewidth=0.5)
        #Link
        axis[int(i/2)][i%2].plot(avg_l_es, ls='dotted', label='MA-ES Link', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_t_es, ls='dotted', label='MA-ES Link, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_avgt_es, ls='dotted', label='MA-ES Link, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_botht_es, ls='dotted', label='MA-ES Link, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_cn, ls='dashed', label='MA-ES-Canonical Link', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_t_cn, ls='dashed', label='MA-ES-Canonical Link, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_avgt_cn, ls='dashed', label='MA-ES-Canonical Link, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_botht_cn, ls='dashed', label='MA-ES-Canonical Link, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_ga, label='CCEA Link', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_t_ga, label='CCEA Link, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_avgt_ga, label='CCEA Link, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(avg_l_botht_ga, label='CCEA Link, both times', linewidth=0.5)
        axis[int(i/2)][i%2].set_ylim(Y_LIM_AVE[i][0], Y_LIM_AVE[i][1])
    elif PLOT_TYPE == 'max':
        #centralized
        axis[int(i/2)][i%2].plot(max_c_es, ls='dotted', label='ES Centralized', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_t_es, ls='dotted', label='ES Centralized, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_avgt_es, ls='dotted', label='ES Centralized, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_botht_es, ls='dotted', label='ES Centralized, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_cn, ls='dashed', label='ES-Canonical Centralized', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_t_cn, ls='dashed', label='ES-Canonical Centralized, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_avgt_cn, ls='dashed', label='ES-Canonical Centralized, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_botht_cn, ls='dashed', label='ES-Canonical Centralized, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_ga, label='CCEA Centralized', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_t_ga, label='CCEA Centralized, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_avgt_ga, label='CCEA Centralized, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_c_botht_ga, label='CCEA Centralized, both times', linewidth=0.5)
        #Intersection
        axis[int(i/2)][i%2].plot(max_i_es, ls='dotted', label='MA-ES Intersection', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_t_es, ls='dotted', label='MA-ES Intersection, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_avgt_es, ls='dotted', label='MA-ES Intersection, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_botht_es, ls='dotted', label='MA-ES Intersection, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_cn, ls='dashed', label='MA-ES-Canonical Intersection', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_t_cn, ls='dashed', label='MA-ES-Canonical Intersection, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_avgt_cn, ls='dashed', label='MA-ES-Canonical Intersection, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_botht_cn, ls='dashed', label='MA-ES-Canonical Intersection, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_ga, label='CCEA Intersection', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_t_ga, label='CCEA Intersection, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_avgt_ga, label='CCEA Intersection, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_i_botht_ga, label='CCEA Intersection, both times', linewidth=0.5)
        #Link
        axis[int(i/2)][i%2].plot(max_l_es, ls='dotted', label='MA-ES Link', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_t_es, ls='dotted', label='MA-ES Link, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_avgt_es, ls='dotted', label='MA-ES Link, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_botht_es, ls='dotted', label='MA-ES Link, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_cn, ls='dashed', label='MA-ES-Canonical Link', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_t_cn, ls='dashed', label='MA-ES-Canonical Link, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_avgt_cn, ls='dashed', label='MA-ES-Canonical Link, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_botht_cn, ls='dashed', label='MA-ES-Canonical Link, both times', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_ga, label='CCEA Link', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_t_ga, label='CCEA Link, last time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_avgt_ga, label='CCEA Link, avg time', linewidth=0.5)
        axis[int(i/2)][i%2].plot(max_l_botht_ga, label='CCEA Link, both times', linewidth=0.5)
    else:
...
fig.set_figwidth(14*1.5)
fig.set_figheight(10*1.5)
axis[0][i%2].set_ylabel('Total Deliveries')
